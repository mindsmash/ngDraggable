            ...
            var onmove = function (evt) {
              ...
              if (!element.hasClass('dragging')) {
                ...
                $rootScope.$broadcast('draggable:start',
                    {x: _mx, y: _my, tx: _tx, ty: _ty, event: evt, element: element, data: _data});
    ...
    .directive('ngPlaceholder', ['$document', function ($document) {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          scope.$watch(attrs.ngPlaceholder, function () {
            toggleListeners(scope.$eval(attrs.ngPlaceholder));
          });

          var toggleListeners = function (enabled) {

            if (enabled) {
              deregister = scope.$on('draggable:start', onDragStart);
            ...
            var createInterval = function () {
              ...
              nextFrame(function () {
                ...
                if (scrollX !== 0 || scrollY !== 0) {
                  ...
                  var horizontalScrollAmount = ($window.pageXOffset || $document[0].documentElement.scrollLeft)
                      - currentScrollLeft;
                  var verticalScrollAmount = ($window.pageYOffset || $document[0].documentElement.scrollTop)
                      - currentScrollTop;
